...
import 'package:hotel_booking/features/authentication/screens/signup/signup.dart';
  ...
  screenRedirect() async {
    ...
    if (user != null) {
      ...
      deviceStorage.read('IsFirstTime') != true
          ...
          : Get.offAll(const LoginScreen()); // Redirect to OnBoarding Screen if it's the first time
    }
  }
